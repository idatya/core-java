...
public class Example1 {
	public static void main(String[] args) {
		List<String> names = Arrays.asList("aditya", "samar", "sudha");
		// sort alphabetically
		...
		/**
		 * Using lambda Things to show >> 1. return statement 2. Without return
		 * statement 3. Multiple lines 4. Type inference
		 */
